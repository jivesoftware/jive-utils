...
/**
 * A class that sets a configuration type directly on a configuration source.
 *
 * @author Merlin Hughes
 * @version 0.1, 2007/04/15
 */
public class DirectTypeSetter extends TypeSetter {
    /* Inherited. */

    @Override
    public void set(ConfigHandler handler, String property, Object value) {
        handler.getConfiguration().setProperty(property, (String) value);
    }
}
