 ...
 * @author jonathan
 */
public class WALPayload implements Comparable {

    private int hashCode = 0;
    private final byte[] bytes;

    @JsonCreator
    public WALPayload(@JsonProperty("bytes") byte[] _bytes) {
        bytes = _bytes;
    }

    public WALPayload(byte[] bytes, int hashCode) {
        this.bytes = bytes;
    ...
    public boolean equals(Object obj) {
        ...
        final WALPayload other = (WALPayload) obj;
    ...
    public int compareTo(Object o) {
        ...
        if (o instanceof byte[]) {
            b = (byte[]) o;
        } else if (o instanceof WALPayload) {
            b = ((WALPayload) o).bytes;
        } else {
            b = new byte[0];
        }
