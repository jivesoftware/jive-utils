 ...
 *
 */
public class RowColumnTimestampRemove<R, C> {

    private final R rowKey;
    private final C columnKey;
    private final Timestamper overrideTimestamper;

    public RowColumnTimestampRemove(R rowKey, C columnKey, Timestamper overrideTimestamper) {
        this.rowKey = rowKey;
    ...
    public boolean equals(Object obj) {
        ...
        final RowColumnTimestampRemove<R, C> other = (RowColumnTimestampRemove<R, C>) obj;
